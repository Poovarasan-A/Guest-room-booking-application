      ...
      <div className="px-20">
        ...
        <div className="w-full flex gap-8 justify-between">
          <div>
            ...
            <div className="py-3">
              <b className="text-lg capitalize">{property?.owner?.name}</b>
            </div>
            <hr className="my-3 border-white/20" />
            <div>
            ...
            <div className="flex flex-wrap gap-3 py-2 pt-4">
              {room &&
                ...
                room.amenities.map((amenity) => (
                  <span className="border-2 border-white/50 p-2 " key={amenity}>
                    {amenity}
                  </span>
                ))}
            </div>
              ...
              >
                ...
                <div className="w-full">
                  ...
                  <p className="text-xs text-center text-white/60">
                    You can only book a min of {room.minBookingDays} days and a
                    max of {room.maxBookingDays} days.
                  </p>
                </div>
              </form>
            </div>
