    ...
    <>
      {loading ? (
        ...
        <div className="text-white">
          ...
          <div className="text-white w-full h-screen flex items-center justify-start relative pt-[3.5rem] ">
              ...
              <div className="flex p-10 gap-[8rem] items-center">
                ...
                <div className="flex flex-col items-center gap-16">
                  <div className="w-[16rem] h-[16rem] rounded-full overflow-hidden bg-white">
                    <img
                      src={user?.images || "/images/default_avatar.png"}
                      alt=""
                ...
                <div className="flex flex-col gap-7">
                  ...
                  <div>
                    <Link
                      ...
                      className="py-2 px-4 border-2 border-blue-500 text-blue-500 rounded-lg hover:bg-blue-500/15"
                    >
                      Edit Profile
                    </Link>
                  </div>
